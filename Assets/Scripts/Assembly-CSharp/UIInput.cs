...
public class UIInput : MonoBehaviour
{
	...
	public virtual bool ProcessEvent(Event ev)
	{
		...
		bool flag = ((Application.unityVersion != "windowsplayer" && Application.unityVersion != "osxplayer" && Application.unityVersion != "osxwebplayer") ? ((ev.modifiers & EventModifiers.Control) != 0) : ((ev.modifiers & EventModifiers.Command) != 0));
