...
public class UICamera : MonoBehaviour
{
	...
	[CompilerGenerated]
	private static BetterList<DepthEntry>.CompareFunc _003C_003Ef__am_0024cache58;

	[CompilerGenerated]
	private static BetterList<DepthEntry>.CompareFunc _003C_003Ef__am_0024cache59;
	...
	public static KeyCode currentKey
	{
		...
		set
		{
			...
			ControlScheme controlScheme = currentScheme;
			mCurrentKey = value;
			ControlScheme controlScheme2 = currentScheme;
			if (controlScheme != controlScheme2)
			{
				HideTooltip();
				if (controlScheme2 == ControlScheme.Mouse)
				{
		...
		for (int i = 0; i < list.size; i++)
		{
			...
			if (uICamera.eventType == EventType.UI_3D)
			{
				...
				if (array.Length > 1)
				{
					...
					{
						_003C_003Ef__am_0024cache58 = _003CRaycast_003Em__3;
					}
					betterList.Sort(_003C_003Ef__am_0024cache58);
			...
			else
			{
				...
				if (array2.Length > 1)
				{
					...
					{
						_003C_003Ef__am_0024cache59 = _003CRaycast_003Em__4;
					}
					betterList2.Sort(_003C_003Ef__am_0024cache59);
	...
	[CompilerGenerated]
	private static int _003CRaycast_003Em__3(DepthEntry r1, DepthEntry r2)
	{
		return r2.depth.CompareTo(r1.depth);
	}

	[CompilerGenerated]
	private static int _003CRaycast_003Em__4(DepthEntry r1, DepthEntry r2)
	{
		return r2.depth.CompareTo(r1.depth);
	}
}
